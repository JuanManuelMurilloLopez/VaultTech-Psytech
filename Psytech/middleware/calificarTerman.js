...
const calificacionesTerman = require('../models/calificacionesTerman.model');
const resultadosSeriesTerman = require('../models/resultadosSeriesTerman.model');

async function calificarSerieTerman(idSerie, idAspirante, idGrupo, respuestas) {
    const calificacionesModel = new calificacionesTerman(idAspirante, idGrupo);
    ...
    const opcionesCorrectas = await terman.fetchOpcionesCorrectasById(idSerie);
