...
// +0 +1
`Se siente exhausto debido a conflictos y discusiones; 
...
// +0 +4
`Se liberan deseos que se originan por situaciones insatisfactorias 
...
// +2
`Quiere conseguir la determinación y la constancia de voluntad 
...
// +2 +0
`Quiere establecer su propia personalidad e influir sobre otros, a 
pesar de las circunstancias desfavorables y de una falta general 
de aprecio por parte de los demás.`

// +2 +1
`Quiere impresionar favorablemente a los demás y conseguir su 
...
// +2 +3
`Busca el éxito. Quiere superar los obstáculos y la oposición y 
...
// +2 +4
`Necesita el reconocimiento de los demás. Ambicioso, quiere 
...
// +2 +5
`Quiere causar una impresión favorable sobre los demás y ser 
...
// +2 +6
`Tiene la impresión de que se le exige demasiado y esto lo 
...
// +2 +7
`Quiere demostrar a sí mismo y a los demás que nada puede 
...
// +3
`Es una persona con una actividad intensa, vital y animada que se 
...
// +3 +0
`Quiere apartar a un lado todas las cosas que le estorban en su 
...
// +3 +1
`Se orienta hacia una vida pletórica de acción y experiencias y 
hacia un vínculo íntimo que le ofrezca la posibilidad de una 
realización sexual y afectiva.`

// +3 +2
`Persigue sus objetivos con intensidad, y no se permite desviarse un 
...
// +3 +4
`Busca el éxito, el estímulo y una vida plena de experiencias. Quiere 
...
// +3 +5
`Se preocupa por cosas que tienen una índole de intensa 
...
// +3 +6
`Desecha sus ambiciones y renuncia a sus deseos de prestigio por 
cuanto prefiere tomarse las cosas con calma y condescender a 
sus ansias de comodidad y seguridad.`

// +3 +7
`Quiere compensar por todo lo que cree que ha perdido viviendo 
...
// +4
`Necesita un cambio de situación o de amistades que alivie de la 
tensión. Busca una solución que le abra nuevas o mejores posibilidades y 
que le permita realizar sus esperanzas.`

// +4 +0
`Necesita una escapatoria de todo lo que lo oprime; se aferra a 
esperanzas vagas e ilusorias.`

// +4 +1
`Confía que los lazos afectivos y de buena camaradería le 
...
// +4 +2
`Es un observador alerta y agudo. Busca nuevas vías que le 
...
// +4 +3
`La necesidad de sentirse más afectivo en su actividad y de tener un 
...
// +4 +5
`Es imaginativo en exceso e inclinado al fantaseo y soñar despierto. 
Ansía que sucedan cosas interesantes y emocionantes; quiere 
ser admirado por su trato agradable.`

// +4 +6
`Está desesperado y necesita un cierto alivio. Quiere bienestar 
físico, una seguridad sin problemas y la oportunidad de 
recuperarse.`

// +4 +7
`Trata de escapar de sus problemas, dificultades y tensiones por 
...
// +5
`Necesita sentirse identificado con algo o alguien y desea ganar el 
apoyo de los demás por su trato agradable y amabilidad. Es 
sentimental y anhela una ternura de tipo romántico.`

// +5 +0
`Ansía una comprensión sensible y empática; quiere estar a 
salvo de discusiones, conflictos o cualquier tensión agotadora.`

// +5 +1
`Ansía una ligazón tierna y empática y una situación idealizada de 
...
// +5 +3
`Acepta fácil y rápidamente todo lo que le proporcione 
...
// +5 +4
`Quiere que sucedan hechos interesantes y emocionantes. Tiene 
...
// +6
`Busca librarse de problemas y lograr un estado seguro de bienestar 
físico en el cual pueda ponerse laxo y recuperarse.`

// +6 +0
`Necesita con urgencia sosiego y reposo, librarse de conflictos y la 
...
// +6 +1
`Quiere estar satisfecho, encontrar bienestar físico y librarse de 
conflictos. Necesita seguridad y se apega a ello de tal modo que 
no tenga que sufrir ni soledad ni separación.`

// +6 +2
`Se mantiene bajo severo control de modo que no le sobrevenga 
...
// +6 +4
`Juzga que las perspectivas de realizar sus esperanzas son pocas y, 
por lo tanto, se entrega a una vida de bienestar sensual, sin 
ningún problema.`

// +6 +5
`Busca el fausto, la comodidad sensual y la entrega a aficiones 
voluptuosas.`

// +6 +7
`Se plantea objetivos idealistas e ilusorios. Se ha decepcionado 
...
// +7
`Considera que las circunstancias presentes son desagradables y  
sobreimpositivas. Se niega a permitir que algo pueda influir sobre 
sus puntos de vista.`

// +7 +0
`Cree que la situación es desesperada. Rechaza enérgicamente
...
// +7 +1
`Sufre con los efectos de todas las cosas que ha evitado por
desagradables (véanse las interpretaciones de -2, -3 ó -4) y las 
rechaza enérgicamente. Sólo quiere que lo dejen en paz.`

// +7 +2
`Se opone desafiadoramente a cualquier clase de restricción u
...
// +7 +3
`Sufre de una contenida sobreestimulación que amenaza con 
...
// +7 +5
`Exige que las ideas y los sentimientos emerjan y se armonicen 
...
// X 0
`Representa una barrera entre los colores compensatorios que le 
...
// X 0 X 1
`Es relativamente inactivo y de condición estática, pero ciertos 
...
// X 0 X 2
`La situación es difícil y el sujeto está tratando de lograr sus objetivos
...
// X 0 X 3
`Tiene dificultades para progresar. A pesar del intento de ocultar su
impulsividad, sus acciones le acarrean problemas e incertidumbres, 
volviéndolo tenso e irritable. (El grupo + es un intento de compensar éste 
y otros conflictos.)`

// X 0 X 4
`La falta de realización de sus esperanzas y la incapacidad de
adoptar las medidas necesarias para su recuperación han contribuido al 
aumento de tensión. 
(El grupo + es un intento de compensar éste y otros conflictos.)`

// X 0 X 5
`El temor al desaire y la extrema cautela en sus aproximaciones le
hacen difícil alcanzar el grado de intimidad e identificación que desea.`

// X 0 X 6
`Es incapaz de esforzarse lo suficiente para lograr sus objetivos. Se  
siente olvidado y desea mayor seguridad, cordialidad y menos problemas. 
(El grupo + es un intento de compensar éste y otros conflictos.)`

// X 0 X 7
`Está bajo una gran tensión debido a las exigencias de la situación 
...
// X 1
`Actúa con calma y con un mínimo de trastornos, de modo que pueda manipular sus 
amistades presentes. Le gusta sentirse relajado y llevarse bien con sus compañeros 
y todos sus íntimos.`

// X 1 X 0
`Sensible y comprensivo pero bajo cierta tirantez; necesita abrirse a 
alguien que le sea íntimo.`

// X 1 X 2
`Actúa de un modo ordenado, metódico y autónomo. Necesita la comprensión 
empática de alguien que reconozca lo que vale y le dé su aprobación.`

// X 1 X 3
`Trabaja bien en colaboración con los demás, pero no se aviene a representar 
roles de liderazgo. Necesita una vida personal de comprensión y sin discordias.`

// X 1 X 4
`Complaciente y adaptable. Se siente en paz sólo cuando está vinculado 
íntimamente a una persona, grupo u organización en el cual pueda depositar 
su confianza.`

// X 1 X 5
`Sensible; necesita entornos estéticos o una pareja tan sensible y comprensiva 
...
// X 1 X 7
`Necesita amigos afectuosos, pero es intolerante con aquellos íntimos que no 
...
// X 2
`Persistente. Exige lo que cree que le es debido y se esfuerza para mantener 
su posición intacta.`

// X 2 X 0
`Defensivo. Cree que su posición está amenazada o establecida de un modo 
inadecuado; está determinado a perseguir sus objetivos a pesar de la ansiedad 
que le produce la oposición.`

// X 2 X 1
`Ordenado, metódico y autónomo. Necesita el respeto, el reconocimiento y 
la comprensión de sus íntimos.`

// X 2 X 3
`Autoritario o en un puesto de autoridad, pero propenso a creer que un 
mayor progreso va a ser difícil debido a los problemas que existen. 
Persevera a pesar de la oposición.`

// X 2 X 4
`Trata de mejorar su posición y prestigio; está insatisfecho con las 
circunstancias presentes y considera que es necesaria una mejoría para su 
autoestima.`

// X 2 X 5
`Lucha para mejorar su imagen a los ojos de los demás y así conseguir que 
éstos acepten y estén de acuerdo con sus necesidades y deseos.`

// X 2 X 6
`Trabaja para edificar una base firme en la que pueda construir un futuro 
seguro, confortable y sin problemas; en esas condiciones espera obtener 
respeto y reconocimiento.`

// X 2 X 7
`Persigue sus objetivos y su propio interés con una determinación obstinada. 
Rechaza hacer componendas o buscar privilegios.`

//-----------------------------------------------------------------------------------------------------------

// X 3
`Es activo, pero juzga que hace progresos limitados y que obtiene una 
recompensa insuficiente por los esfuerzos que realiza.`

// X 3 X 0
`Impulsivo e irritable. Sus deseos y acciones concomitantes son muy altos, 
pero se concede poca importancia a las consecuencias. Esto lleva a tensión 
y conflicto o al resultado de ellos.`

// X 3 X 1
`Trabaja bien en colaboración con los demás. Necesita una vida personal de 
comprensión mutua y sin discordias.`

// X 3 X 2
`Desarrolla iniciativa para superar los obstáculos y las dificultades. 
...
// X 3 X 6
`No quiere comunicarse con los demás ni hacer esfuerzos excesivos 
...
// X 3 X 7
`Se siente obstaculizado en sus deseos e impedido de obtener todo lo que 
